...
class Member(models.Model):
    ...
    twitch_id = models.CharField(max_length=255, unique=True, null=True, blank=True, db_index=True)
    youtube_id = models.CharField(max_length=255, unique=True, null=True, blank=True, db_index=True)
    discord_id = models.CharField(max_length=255, unique=True, null=True, blank=True, db_index=True)
...
class Event(models.Model):
    ...
    member = models.ForeignKey(Member, on_delete=models.CASCADE, null=True, blank=True, related_name='events')
    ...
    def username(self):
        ...
        return (self.payload.get('user_login') or
                self.payload.get('user_name') or
