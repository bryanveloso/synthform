...
if not DEBUG:
    sentry_sdk.init(
        ...
        ignore_errors=[
            KeyboardInterrupt,
            SystemExit,
            "shared.services.twitch.service.ScheduledRestartException",
        ],
...
EVENTSUB_STALENESS_THRESHOLD_SECONDS = env.int(
    "EVENTSUB_STALENESS_THRESHOLD_SECONDS", default=900
)  # EventSub staleness threshold (15 minutes)
...
OBS_PERFORMANCE_MONITOR_ENABLED = env("OBS_PERFORMANCE_MONITOR_ENABLED", default=True)
OBS_FRAME_DROP_THRESHOLD_TRIGGER = env("OBS_FRAME_DROP_THRESHOLD_TRIGGER", default=1.0)
OBS_FRAME_DROP_THRESHOLD_CLEAR = env("OBS_FRAME_DROP_THRESHOLD_CLEAR", default=0.5)
