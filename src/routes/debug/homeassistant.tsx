...
const ENTITY_GROUPS: Record<string, string[]> = {
  'Rack Power': [
    'sensor.usp_pdu_pro_ac_power_consumption',
    'sensor.usp_pdu_pro_ac_power_budget',
    'sensor.usp_pdu_pro_outlet_5_outlet_power',
    'sensor.usp_pdu_pro_outlet_6_outlet_power',
    'sensor.usp_pdu_pro_outlet_7_outlet_power',
    'sensor.usp_pdu_pro_outlet_8_outlet_power',
    'sensor.usp_pdu_pro_outlet_9_outlet_power',
    'sensor.usp_pdu_pro_outlet_10_outlet_power',
    'sensor.usp_pdu_pro_outlet_11_outlet_power',
    'sensor.usp_pdu_pro_outlet_12_outlet_power',
    'sensor.usp_pdu_pro_outlet_13_outlet_power',
  ],
  'Solar & Battery': [
  ...
  'Weather (Tempest)': [
    ...
    'sensor.tempest_feels_like',
    'sensor.tempest_dew_point',
    'sensor.tempest_wind_speed',
    'sensor.tempest_wind_speed_avg',
    'sensor.tempest_wind_gust',
    'sensor.tempest_wind_direction',
    'sensor.tempest_pressure_barometric',
    'sensor.tempest_pressure_sea_level',
    'sensor.tempest_air_density',
    'sensor.tempest_lightning_count',
    'sensor.tempest_lightning_count_last_1_hr',
    'sensor.tempest_lightning_last_distance',
  ...
  'Climate (Indoor)': [
    ...
    'sensor.vital_200s_series_pm2_5',
    'sensor.vital_200s_series_air_quality',
    'sensor.vital_200s_series_filter_lifetime',
  ],
  'EV (Polestar 3)': [
    'sensor.polestar_5857_battery_charge_level',
    'sensor.polestar_5857_estimated_range',
    'sensor.polestar_5857_estimated_full_charge_range',
  ...
  'Server (Unraid)': [
    ...
    'sensor.unraid_disk1_usage',
    'sensor.unraid_disk2_usage',
    'sensor.unraid_disk3_usage',
    'sensor.unraid_br0_inbound',
    'sensor.unraid_br0_outbound',
    'sensor.unraid_log_filesystem_usage',
  ...
  Network: [
    ...
    'sensor.usw_pro_24_poe_cpu_utilization',
    'sensor.usw_pro_24_poe_memory_utilization',
    'sensor.usw_pro_24_poe_temperature',
    'sensor.u7_pro_max_cpu_utilization',
    'sensor.u7_pro_max_memory_utilization',
  ],
  Devices: [
    'sensor.demi_frontmost_app',
    'sensor.demi_primary_display_name',
